...
const ImageScreen = () => {
  ...
  const item = useLocalSearchParams(); //through this hook we gets the image data which we have clicked on
  let uri = item?.webformatURL;

  //extracting file anme and file path for downloading the image
  ...
  //for downloading the file we use
